...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CloudRestore'
        db.create_table(u'tasks_cloudrestore', (
            ...
            ('last_status', self.gf('django.db.models.fields.CharField')(default='', max_length=200)),
        ))
        db.send_create_signal(u'tasks', ['CloudRestore'])


    def backwards(self, orm):
        # Deleting model 'CloudRestore'
        db.delete_table(u'tasks_cloudrestore')
    ...
    models = {
        ...
        u'tasks.cloudrestore': {
            'Meta': {'ordering': "['path']", 'object_name': 'CloudRestore'},
            'attributes': ('freenasUI.freeadmin.models.fields.DictField', [], {}),
            'credential': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['system.CloudCredentials']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_status': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '200'}),
